...
Route::group(['prefix' => 'sales'], function () {
    ...
    Route::get('invoices/{invoice}/pdf/{lang?}', 'Sales\Invoices@pdfInvoice')->name('invoices.pdf');
...
Route::group(['prefix' => 'purchases'], function () {
    ...
    Route::get('bills/{bill}/pdf/{lang?}', 'Purchases\Bills@pdfBill')->name('bills.pdf');
...
Route::group(['prefix' => 'banking'], function () {
    ...
    Route::get('transactions/{transaction}/pdf/{lang?}', 'Banking\Transactions@pdfTransaction')->name('transactions.pdf');
    ...
    Route::get('transfers/{transfer}/pdf/{lang?}', 'Banking\Transfers@pdfTransfer')->name('transfers.pdf');
