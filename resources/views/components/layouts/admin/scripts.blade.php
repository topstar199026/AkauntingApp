...
<script type="text/javascript">
    function atgStoreValue() {
        document.getElementById("atg_shipping").value = document.getElementById("SelectedShipAddr").value;
    }

    // copy projects name to at invoices start
    for (var clickButton of document.getElementsByName("at_inv_project_nbr"))
        clickButton.addEventListener("click", alertMeessage);
    function alertMeessage() {
        document.getElementById("at_inv_project_nbr").value = document.getElementsByClassName("el-input__inner")[0].value;
    }
    // copy projects name to at invoices end
