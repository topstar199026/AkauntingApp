...
@if (! $hideMoreActions)
    <x-dropdown id="show-more-actions-{{ $document->type }}">
        ...
        @if (! $hidePdf)
            ...
            <x-dropdown.link href="{{ route($pdfRoute, [$document->id,'en-US']) }}" id="show-more-actions-pdf-{{ $document->type }}">
                {{ trans('Download PDF in English') }}
            </x-dropdown.link>

            <x-dropdown.link href="{{ route($pdfRoute, [$document->id,'de-DE']) }}" id="show-more-actions-pdf-{{ $document->type }}">
                {{ trans('Download PDF in German') }}
            </x-dropdown.link>
           
            <x-dropdown.link href="{{ route($pdfRoute, [$document->id,'tr-TR']) }}" id="show-more-actions-pdf-{{ $document->type }}">
                {{ trans('Download PDF in Turquish') }}
            </x-dropdown.link>
        @endif
