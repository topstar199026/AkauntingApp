    ...
    'fallback' => [
        'estimates' => [
            'estimate' => [
                ...
                'item_name'                 => env('SETTING_FALLBACK_ESTIMATE_ITEM_NAME', 'settings.invoice.item'),
                'price_name'                => env('SETTING_FALLBACK_ESTIMATE_PRICE_NAME', 'settings.invoice.price'),
                'quantity_name'             => env('SETTING_FALLBACK_ESTIMATE_QUANTITY_NAME', 'settings.invoice.quantity'),
