...
return [
    ...
    'estimate_view_admin'      => [
        'subject' => 'Devis N°{estimate_number} a été vu',
        'body'    => 'Bonjour,' .
                     '<br /><br />' .
                     '{customer_name} a consulté le devis N°<strong>{estimate_number}</strong>.' .
                     '<br /><br />' .
                     'Vous pouvez consulter les détails du devis à partir du lien suivant : ' .
                     '<a href="{estimate_admin_link}">{estimate_number}</a>.' .
                     '<br /><br />' .
    ...
    'estimate_approved_admin' => [
        'subject' => 'Devis N°{estimate_number} a été approuvé',
        'body'    => 'Bonjour,' .
                     '<br /><br />' .
