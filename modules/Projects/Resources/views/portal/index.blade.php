<x-layouts.portal>
    ...
    <x-slot name="buttons">
        @can('create-projects-portal-projects')
            <x-link :href="route('portal.projects.projects.create')" kind="primary">
    ...
    <x-slot name="content">
                ...
                <x-table>
                    ...
                    <x-table.tbody>
                        @foreach($projects as $project)
                            <x-table.tr href="{{ route('portal.projects.projects.show', $project->id) }}">
        ...
        @else
        <x-empty-page group="projects" page="projects" hide-button-create hide-button-import />
        @endif
    </x-slot>
