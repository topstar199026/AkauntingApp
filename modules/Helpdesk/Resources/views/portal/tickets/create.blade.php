<x-layouts.admin>
    ...
    <x-slot name="content">
        <x-form.container>
            <x-form id="ticket" route="portal.helpdesk.tickets.store">
                <x-form.section>
                    <x-slot name="head">
                    ...
                    <x-slot name="body">
                        ...
                        <x-form.group.category type="ticket" without-add-new />
                ...
                <x-form.section>
                    <x-slot name="foot">
                        <x-form.buttons cancel-route="portal.helpdesk.tickets.index" />
                    </x-slot>
                </x-form.section>
            </x-form>
        </x-form.container>
