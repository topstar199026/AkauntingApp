                        ...
                        <tbody>
                            ...
                            @foreach($debit_note->items as $debit_note_item)
                                <tr class="row">
                                    ...
                                    <td class="col-sm-3 text-right d-none d-sm-block">
                                        <x-money amount="{{ $debit_note_item->price }}" currency="{{ $debit_note->currency_code }}" convert />
                                    </td>
                                    <td class="col-xs-4 col-sm-3 text-right pr-5">
                                        <x-money amount="{{ $debit_note_item->total }}" currency="{{ $debit_note->currency_code }}" convert />
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                                ...
                                @foreach($debit_note->totals_sorted as $total)
                                    @if($total->code != 'total')
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <x-money amount="{{ $total->amount }}" currency="{{ $debit_note->currency_code }}" convert />
                                            </td>
                                        </tr>
                                    @else
                                        <tr>
