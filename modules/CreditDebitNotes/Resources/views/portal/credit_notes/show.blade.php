...
{{--    <a href="{{ route('portal.credit-debit-notes.credit-notes.print', $credit_note->id) }}" target="_blank" class="btn btn-success btn-sm">--}}
{{--        {{ trans('general.print') }}--}}
{{--    </a>--}}
{{--    @stack('button_print_end')--}}

{{--    @stack('button_pdf_start')--}}
{{--    <a href="{{ route('portal.credit-debit-notes.credit-notes.pdf', $credit_note->id) }}" class="btn btn-white btn-sm">--}}
