...
Route::admin('credit-debit-notes', function () {
    ...
    Route::get('customers/{customer}/create-credit-note', 'Customers@createCreditNote')->name('customers.create-credit-note');
...
//            // TODO: implement export
    ...
    Route::get('vendors/{vendor}/create-debit-note', 'Vendors@createDebitNote')->name('vendors.create-debit-note');
