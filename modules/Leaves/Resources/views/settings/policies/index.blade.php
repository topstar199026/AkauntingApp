                        ...
                        <x-table>
                            <x-table.thead>
                                <x-table.tr class="flex items-center px-1">
                                    ...
                                    <x-table.th class="w-4/12 sm:w-4/12">
                                        {{ trans_choice('leaves::general.leave_types', 1) }}
                                    </x-table.th>
                                    <x-table.th class="w-2/12 sm:w-2/12">
                                        {{ trans_choice('leaves::general.years', 1) }}
                                    </x-table.th>
                                    <x-table.th class="w-2/12 sm:w-2/12">
                                        {{ trans('leaves::policies.days') }}
                                    </x-table.th>
                                </x-table.tr>
                            </x-table.thead>
                            <x-table.tbody>
                                    ...
                                    <x-table.tr>
                                        <x-table.td class="w-4/12 sm:w-4/12 truncate">
                                            @if(user()->can('update-leaves-settings'))
                                                <x-link
                                                    :href="route('leaves.settings.policies.edit', $policy->id)"
                                        ...
                                        <x-table.td class="w-2/12 sm:w-2/12">
                                            {{ $policy->year->name }}
                                        </x-table.td>
                                        <x-table.td class="w-2/12 sm:w-2/12">
                                            {{ $policy->days }}
