<x-layouts.admin>
    <x-slot name="title">
        {{ trans('general.title.edit', ['type' => trans('leaves::general.leave_year')]) }}
    </x-slot>
    ...
    <x-slot name="content">
        <x-form.container>
            <x-form
                id="year" 
                :route="['leaves.settings.years.update', $year->id]"
                method="PATCH"
                :model="$year">
                <x-form.section>
                    <x-slot name="head">
                    ...
                    <x-slot name="body">
                        ...
                        <x-form.group.date
                            name="start_date"
                            :label="trans('leaves::years.start_date')"
                        ...
                        <x-form.group.date
                            name="end_date"
                            :label="trans('leaves::years.end_date')"
                            :show-date-format="company_date_format()"
                            date-format="Y-m-d"
