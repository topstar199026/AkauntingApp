...
Route::admin(
    ...
    function () {
        ...
        Route::group(
            ...
            function () {
                Route::resource('sales-orders/{sales_order}/emails', 'SalesOrdersEmails', ['names' => 'sales-orders.emails']);
                Route::resource('purchase-orders/{purchase_order}/emails', 'PurchaseOrdersEmails', ['names' => 'purchase-orders.emails']);
            }
        );
    }
);
