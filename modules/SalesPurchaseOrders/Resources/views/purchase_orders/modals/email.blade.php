<x-form id="form-email" :route="['sales-purchase-orders.modals.purchase-orders.emails.store', $purchaseOrder->id]">
    <x-form.section>
        <x-slot name="body">
            <x-form.group.text name="to" label="{{ trans('general.to') }}" value="{{ $purchaseOrder->contact->email }}" form-group-class="sm:col-span-6" />
            ...
            <x-form.input.hidden name="document_id" :value="$purchaseOrder->id" />
        </x-slot>
    </x-form.section>
</x-form>
