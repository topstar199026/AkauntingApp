...
class SalesOrder extends Notification
{
    ...
    public function __construct(Document $salesOrder, string $template_alias = null, bool $attach_pdf = false)
    {
        parent::__construct();

        $this->salesOrder = Model::find($salesOrder->id);
    ...
    public function getTagsReplacement(): array
    {
        return [
            ...
            route('sales-purchase-orders.sales-orders.show', $this->salesOrder->id),
        ];
    }
}
