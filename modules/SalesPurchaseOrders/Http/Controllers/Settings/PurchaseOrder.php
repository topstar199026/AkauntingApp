...
namespace Modules\SalesPurchaseOrders\Http\Controllers\Settings;

use App\Abstracts\Http\SettingController as Controller;
...
class PurchaseOrder extends Controller
{
    public function edit()
    {
        ...
        return view(
            'sales-purchase-orders::settings.purchase_order',
            compact(
                'item_names',
                'price_names',
                'quantity_names',
