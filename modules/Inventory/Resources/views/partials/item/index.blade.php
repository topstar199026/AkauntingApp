            ...
            <table class="table table-flush table-hover">
                <thead class="thead-light">
                    <tr class="row table-head-line">
                        ...
                        <th class="col-xs-4 col-sm-4 col-md-4 col-lg-2 col-xl-2">@sortablelink('name', trans('general.name'), ['filter' => 'active, visible'], ['class' => 'col-aka', 'rel' => 'nofollow'])</th>
                        ...
                        <th class="col-md-3 col-lg-3 col-xl-2 text-right d-none d-md-block">@sortablelink('sale_price', trans('items.sale_price'))</th>
                ...
                <tbody>
                    @foreach($items as $item)
                        <tr class="row align-items-center border-top-1">
                            ...
                            <td class="col-lg-1 col-xl-1 text-center hidden-lg">
                                {{ ($item->inventory()->sum('opening_stock')) ? $item->inventory()->sum('opening_stock') : trans('general.na') }}
                            </td>
