...
Route::admin('inventory', function () {
    ...
    Route::get('items/{item}/duplicate', 'Items@duplicate')->name('items.duplicate');
    ...
    Route::get('items/{item}/generate-barcode', 'Items@generateBarcode')->name('items.generate-barcode');
    ...
    Route::resource('items', 'Items', ['middleware' => ['money', 'dropzone']]);
    ...
    Route::resource('item-groups', 'ItemGroups', ['middleware' => ['money', 'dropzone']]);
