...
class ItemGroup extends Request
{
    ...
    public function rules()
    {
        ...
        if ($this->getMethod() == 'PATCH') {
            ...
            $sku = 'nullable|string|unique:inventory_items,NULL,,item_id,company_id,' . $company_id . ',deleted_at,NULL';
        }
        ...
        if ($items) {
            foreach ($items as $item) {
                ...
                if (!isset($item['name']) || !isset($item['sale_price']) || !isset($item['purchase_price'])) {
                    $price_tab = 'required';
                }
            }
        } else {
        ...
        return [
            ...
            'variants.*.variant_values' =>  'required',
    ...
    public function messages()
    {
        return [
            ...
            'variants.*.variant_values.required' => trans('validation.required', ['attribute' => mb_strtolower(trans_choice('inventory::variants.values',  1))]),
