...
use Modules\Inventory\Jobs\ItemGroups\DuplicateItemGroup;
...
class ItemGroups extends Controller
{
    ...
    */
    ...
    {
        $response = $this->ajaxDispatch(new DuplicateItemGroup($item_group));
        ...
        return redirect()->route('inventory.item-groups.index');
    }
