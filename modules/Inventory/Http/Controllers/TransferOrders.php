...
class TransferOrders extends Controller
{
    ...
    public function ready(TransferOrder $transfer_order)
    {
        $transfer_order->update(['status' => 'ready']);
    ...
    public function inTransfer(TransferOrder $transfer_order)
    {
        $transfer_order->update(['status' => 'in_transfer']);
    ...
    public function transferred(TransferOrder $transfer_order)
    {
    ...
    public function cancelled(TransferOrder $transfer_order)
    {
